				...
				<div className="w-11/12 md:w-2/3 mx-auto h-auto md:h-[400px] flex flex-col-reverse md:flex-row justify-between py-4 mt-10">
					...
					>
						...
						<span className="text-neutral-400 font-kanit font-light text-base md:text-lg text-right">
							Experience the best rides with our curated routes that take
							you through breathtaking landscapes and thrilling twists and
							turns
						</span>
					</div>
					<div
				...
				<div className="w-11/12 md:w-2/3 mx-auto h-auto md:h-[400px] flex flex-col md:flex-row justify-between py-4 mt-10">
					...
					>
						...
						<span className="text-neutral-400 font-kanit font-light text-base md:text-lg text-left">
							...
							adventure. Discover scenic drives and hidden gems near you
				...
				<div className="w-11/12 md:w-2/3 mx-auto h-auto md:h-[400px] flex flex-col-reverse md:flex-row justify-between py-4 mt-10">
					...
					>
						...
						<span className="text-neutral-400 font-kanit font-light text-base md:text-lg text-right">
							...
							community. Upload photos, write reviews, and inspire others
							with your stories
						</span>
					</div>
					<div
				...
				<div className="w-11/12 md:w-2/3 mx-auto h-auto md:h-[400px] flex flex-col md:flex-row justify-between py-4 mt-10">
					...
					>
						...
						<span className="text-neutral-400 font-kanit font-light text-base md:text-lg text-left">
							...
							off-the-beaten-path trails, discover places only known to
				...
				<div className="w-11/12 md:w-2/3 mx-auto h-auto md:h-[400px] flex flex-col-reverse md:flex-row justify-between py-4 mt-10">
					...
					>
						...
						<span className="text-neutral-400 font-kanit font-light text-base md:text-lg text-right">
							...
							route builder to plan every detail of your ride and share it
							with the community
						</span>
					</div>
					<div
